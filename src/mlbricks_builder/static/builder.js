(function(){
  ...
  function mount(root,payload){
    ...
    // v0.7.52: Module/API editors use direct insertion only.
    // Components are added from the left library, while Add Module creates a
    // nested Module immediately. There is no intermediate picker/overlay and
    // no per-layer + insertion affordance.
    ...
    function draw(){
      ...
      const frontendVersion=root.dataset.mlbricksBuilderVersion||"0.7.52";
