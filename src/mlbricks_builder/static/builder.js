  ...
  function mount(root,payload){
    ...
    function constructorPreview(node){
      ...
      if(node.type==="soup"){
        ...
        return "from mlbricks import SOUP\n\n"+varname+" = SOUP(\n"+
      ...
      if(node.type==="elasticbit_runtime"){
        ...
        return "from mlbricks import ElasticBit\n\n"+
    ...
    function draw(){
      ...
      const frontendVersion=root.dataset.mlbricksBuilderVersion||"0.7.37";
