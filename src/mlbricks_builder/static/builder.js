(function(){
  ...
  function mount(root,payload){
    ...
    // v0.7.53: direct nested Module creation for both Module and API editors.
    ...
    function draw(){
      ...
      const frontendVersion=root.dataset.mlbricksBuilderVersion||"0.7.53";
