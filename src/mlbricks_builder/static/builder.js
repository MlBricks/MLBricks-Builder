  ...
  function mount(root,payload){
    ...
    function constructorPreview(node){
      ...
      if(node.type==="stateaware_esa_stack"){
        const p=node.params||{};
        return "from mlbricks import ESA, RMSNorm, StateAwareFFN, ResController\n\n"+
    ...
    function draw(){
      ...
      const frontendVersion=root.dataset.mlbricksBuilderVersion||"0.7.38";
