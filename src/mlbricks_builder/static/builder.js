(function(){
  ...
  function mount(root,payload){
    ...
    function draw(){
      ...
      const frontendVersion=root.dataset.mlbricksBuilderVersion||"0.7.49";
      ...
      if(!comp.nodes.length){
        ...
        if(comp.kind==="custom_edit"){
          ...
          e.innerHTML=String(def?.implementation||"graph")==="api"
            ?"<strong>API Component execution graph.</strong><br><br>Add API functions, built-in Components, or reusable Modules. Use + Add Module above for saved/new Modules."
